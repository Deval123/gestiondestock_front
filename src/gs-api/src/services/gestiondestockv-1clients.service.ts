...
class Gestiondestockv1clientsService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v1/clients/all';
  static readonly savePath = '/gestiondestock/v1/clients/create';
  static readonly findByMailPath = '/gestiondestock/v1/clients/{mail}';
  static readonly findByNomPath = '/gestiondestock/v1/clients/{nom}';
  ...
  findByMailResponse(mail: string): __Observable<__StrictHttpResponse<ClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v1/clients/${encodeURIComponent(String(mail))}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  findByNomResponse(nom: string): __Observable<__StrictHttpResponse<ClientDto>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v1/clients/${encodeURIComponent(String(nom))}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  findByNom(nom: string): __Observable<ClientDto> {
...
module Gestiondestockv1clientsService {
}

export { Gestiondestockv1clientsService }
